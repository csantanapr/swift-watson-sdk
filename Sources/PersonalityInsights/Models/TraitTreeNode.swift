...
public struct TraitTreeNode {
    ...
    public init(json: JSON) {
        ...
        samplingError = json["sampling_error"].doubleValue
        rawScore = json["raw_score"].doubleValue
        rawSamplingError = json["raw_sampling_error"].doubleValue
        children = json["children"].arrayValue.map(TraitTreeNode.init)
    }
}
