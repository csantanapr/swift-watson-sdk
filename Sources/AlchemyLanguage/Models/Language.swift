...
public struct Language {
    ...
    public init(json: JSON) {
        ...
        url = json["url"].string
        ethnologue = json["ethnologue"].string
        iso6391 = json["iso-639-1"].string
        iso6392 = json["iso-639-2"].string
        iso6393 = json["iso-639-3"].string
        nativeSpeakers = json["native-speakers"].string
